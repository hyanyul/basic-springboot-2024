...
import com.hyanyul.backboard.service.ResetService;
import com.hyanyul.backboard.validation.MemberForm;
...
public class MemberController {
    ...
    public String resetPassword(MemberForm memberForm, @PathVariable("uuid") String uuid) {
    ...
    public String resetPassword(@Valid MemberForm memberForm, BindingResult bindingResult) {
